        ...
        <div className={styles.sectionInner}>
          <div className={styles.sectionHead}>
            <div>
              ...
              <h2 className={styles.sectionTitle}>
                Built around what good coaching <em>actually requires.</em>
              </h2>
            </div>
            <p className={styles.sectionCopy}>
              Expertise matters, but so do personalization, communication,
              consistency, and the ability to respond as your body and goals evolve.
            </p>
          </div>
          <div className={styles.whyGrid}>
            {reasons.map((reason, index) => {
              ...
              return (
                <article className={styles.whyCard} key={reason.title}>
        ...
        <div className={styles.sectionInner}>
          <div className={styles.sectionHead}>
            <div>
              ...
              <h2 className={styles.sectionTitle}>
                Coaching for every stage of <em>performance.</em>
              </h2>
            </div>
            <div>
              <p className={styles.sectionCopy}>
                From foundational fitness to rehabilitation and elite
                performance, choose a service built around the kind of support
                your goal demands.
              </p>
              <Link href="/register" className={styles.sectionAction}>
                Register now <ArrowRight size={16} aria-hidden="true" />
              </Link>
            </div>
          </div>
          <div className={`${styles.serviceGrid} ${styles.landingServiceGrid}`}>
